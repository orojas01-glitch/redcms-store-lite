...
Status: P3B-4 is implemented in Store Lite 0.1.35 as a disposable acceptance
...
1. discover and integrity-validate Store Lite 0.1.35 without executing it;
...
or any Store Lite version other than 0.1.35. It never targets
