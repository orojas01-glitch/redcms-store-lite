...
Status: P3B-4 remains implemented in Store Lite 0.1.45 as a disposable acceptance
...
1. discover and integrity-validate Store Lite 0.1.45 without executing it;
...
or any Store Lite version other than 0.1.45. It never targets
