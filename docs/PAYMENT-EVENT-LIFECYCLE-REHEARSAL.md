...
Status: P3B-4 remains implemented in Store Lite 0.1.40 as a disposable acceptance
...
finishes with the separately scoped 12-assertion read-only destination-preview
...
1. discover and integrity-validate Store Lite 0.1.40 without executing it;
...
or any Store Lite version other than 0.1.40. It never targets
