...
Status: P3B-4 remains implemented in Store Lite 0.1.36 as a disposable acceptance
...
1. discover and integrity-validate Store Lite 0.1.36 without executing it;
...
or any Store Lite version other than 0.1.36. It never targets
