...
Status: P3B-4 remains implemented in Store Lite 0.1.43 as a disposable acceptance
...
1. discover and integrity-validate Store Lite 0.1.43 without executing it;
...
or any Store Lite version other than 0.1.43. It never targets
